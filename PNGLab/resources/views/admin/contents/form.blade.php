<div class="bg-white p-6 rounded-2xl shadow-xl space-y-6 border border-gray-100 text-[#193053]">
    ...
    <div class="mb-4">
        <label for="body" class="block text-sm font-semibold text-[#193053] mb-2">Isi Materi</label>
    ...
    <div class="mb-4">
        <label class="block text-sm font-semibold text-[#193053] mb-2">Media URL (YouTube)</label>
        
        <div id="url-wrapper" class="flex flex-col space-y-2"> 
            <div class="flex items-center space-x-2 w-full">
                <input type="text" name="media_urls[]" placeholder="https://..." class="border border-gray-300 p-3 w-full rounded-xl bg-gray-50 focus:ring-[#446AA6] focus:border-[#446AA6]">
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-200">
        ...
        <div>
            <label for="course_id" class="block text-sm font-semibold text-[#193053] mb-2">Pilih Course</label>
    ...
    <div class="pt-6">
        <button type="submit" class="bg-[#446AA6] text-white px-5 py-2 rounded-full font-semibold hover:bg-[#264069] transition shadow-md">
...
function addUrl() {
    ...
    newDiv.className = 'flex items-center space-x-2 w-full mt-2';
