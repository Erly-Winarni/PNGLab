    ...
    <div x-data="{ showModal: false, formAction: '' }" class="py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6 pb-3 border-b border-gray-200">
                <h1 class="text-3xl font-extrabold text-[#193053]">Daftar Materi (Admin)</h1>
                ...
                <table class="min-w-full text-left">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 font-bold text-md text-gray-600 uppercase tracking-wider hidden lg:table-cell">Urutan</th>
                        ...
                        @forelse($contents as $c)
                            <tr class="hover:bg-gray-50 transition border-t border-gray-100">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 hidden md:table-cell">
                                    {{ $c->course->teacher->name ?? '-' }}
                                </td>
                                
                                <td class="px-6 py-4 text-sm text-gray-600 hidden lg:table-cell">
                                    <span class="px-3 py-1 bg-gray-200 rounded-full font-semibold text-xs">{{ $c->order }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center space-x-3 whitespace-nowrap">
                                    ...
                                    <button
                                        type="button"
                                        @click="showModal = true; formAction = '{{ route('admin.contents.destroy', $c->id) }}';"
