<x-app-layout>
    ...
    {{-- Jika ingin header, isi bagian ini --}}
    <x-slot name="header">
    ...
    <section class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-24">
        <div class="max-w-6xl mx-auto px-6 text-center">
            <h1 class="text-4xl font-bold mb-4">
                Selamat Datang di <span class="text-yellow-300">PNGLab</span>
            </h1>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="flex gap-3 flex-wrap">
                @foreach ($categories as $cat)
                    <a href="{{ route('teacher.courses.index', ['category' => $cat->id]) }}"
                       class="px-4 py-2 bg-white rounded-full shadow text-gray-700 
